...
const PolaroidGrid = () => {
  const polaroids = [
    {
      id: 1,
      src: '/images/hero/polaroid-1.jpg',
      alt: 'Behind the scenes shot 1',
      caption: 'ON SET'
    },
    {
      id: 2,
      src: '/images/hero/polaroid-2.jpg',
      alt: 'Behind the scenes shot 2',
      caption: 'CREATIVE PROCESS'
    },
    {
      id: 3,
      src: '/images/hero/polaroid-3.jpg',
      alt: 'Behind the scenes shot 3',
      caption: 'COLLABORATION'
    },
    {
      id: 4,
      src: '/images/hero/polaroid-4.jpg',
      alt: 'Behind the scenes shot 4',
      caption: 'FINAL RESULT'
    },
    {
      id: 5,
      src: '/images/hero/polaroid-5.jpg',
      alt: 'Behind the scenes shot 5',
      caption: 'TEAM WORK'
    },
    {
      id: 6,
      src: '/images/hero/polaroid-6.jpg',
